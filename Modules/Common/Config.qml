...
Singleton {
    ...
    FileView {
        ...
        JsonAdapter {
            ...
            // Panel system
            property list<string> enabledPanels: ["linuxBar","linuxBackground", "linuxNotificationPopup", "linuxWallpaperSelector"]
            ...
            property JsonObject sidebar: JsonObject {
                ...
                property JsonObject ytmusic: JsonObject {
                    ...
                    property string browser: "chrome"
            ...
            property JsonObject windows: JsonObject {
                ...
                property JsonObject actionCenter: JsonObject {
                    property list<string> toggles: ["network", "bluetooth", "easyEffects", "powerProfile", "idleInhibitor", "nightLight", "darkMode", "antiFlashbang", "cloudflareWarp", "mic", "musicRecognition", "notifications", "onScreenKeyboard", "screenSnip", "colorPicker"]
                }

...
Singleton {
    ...
    readonly property var availableTags: [
        { id: "dark", name: TranslationService.tr("Dark"), icon: "dark_mode" },
        { id: "light", name: TranslationService.tr("Light"), icon: "light_mode" },
        { id: "pastel", name: TranslationService.tr("Pastel"), icon: "palette" },
        { id: "vibrant", name: TranslationService.tr("Vibrant"), icon: "colorize" },
        { id: "minimal", name: TranslationService.tr("Minimal"), icon: "remove" },
        { id: "retro", name: TranslationService.tr("Retro"), icon: "history" },
        { id: "nature", name: TranslationService.tr("Nature"), icon: "eco" },
        { id: "neon", name: TranslationService.tr("Neon"), icon: "bolt" }
    ]

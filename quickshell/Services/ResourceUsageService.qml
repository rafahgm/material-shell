...
Singleton {
    ...
    property string maxAvailableMemoryString: kbToGbString(ResourceUsageService.memoryTotal)
    property string maxAvailableSwapString: kbToGbString(ResourceUsageService.swapTotal)

...
Singleton {
    ...
    ColorQuantizer {
        id: wallColorQuant
        property string wallpaperPath: WallpapersService.effectiveWallpaperPath
    ...
    property bool animationsEnabled: !(Config.options?.performance?.reduceAnimations ?? false)
    

    onEffectsEnabledChanged: if (Qt.application.arguments.indexOf("--debug") !== -1) console.log("[Appearance] effectsEnabled:", effectsEnabled)

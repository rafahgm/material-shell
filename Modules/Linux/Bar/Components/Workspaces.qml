    ...
    Grid {
        ...
        Repeater {
            ...
            Rectangle {
                ...
                color: Appearance.angelEverywhere ? Appearance.angel.colGlassCard : Appearance.auroraEverywhere ? Appearance.aurora.colSubSurface : ColorUtils.transparentize(Appearance.m3colors.m3secondaryContainer, 0.4)
        ...
        Repeater {
            ...
            Button {
                ...
                background: Item {
                    ...
                    property string appIconSource: AppSearchService.getIconSource(columnButton.modelData?.app_id ?? "")

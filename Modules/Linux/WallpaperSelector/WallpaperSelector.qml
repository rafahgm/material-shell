...
Scope {
    ...
    readonly property var focusedScreen: (Quickshell.screens.find(s => s.name === NiriService.currentOutput) ?? Quickshell.screens[0])
    ...
    Loader {
        ...
        sourceComponent: PanelWindow {
            ...
            property bool monitorIsFocused: panelWindow.screen?.name === NiriService.currentOutput
